    ...
    with tag('html'):
        ...
        with tag('body'):
            ...
            with tag('div', id="first", style="width: 300px; float:left; border: 1px solid black;"):
                ...
                with tag('p',
                         style="text-decoration: underline; margin-left: 5px; margin-top: 0px; margin-bottom: 0px;"):
                    text("Stats")
            ...
            with tag('div', id="second", style="overflow: hidden;"):
                with tag('input', type="text", id="myInput5", onkeyup="myFunction(5, 'myInput4')", placeholder="*",
                         title="Type in a name",
                         style="width:35px; margin-left: 0px; margin-right: 0px; padding: 0px;"):
                    pass
                with tag('input', type="text", id="myInput", onkeyup="myFunction(0, 'myInput')",
                         placeholder="Search for IP..", title="Type in a name",
                         style="width:100px; margin-left: 0px; margin-right: 0px; padding: 0px;"):
                    pass
                with tag('input', type="text", id="myInput1", onkeyup="myFunction(1, 'myInput1')",
                         placeholder="Search for Port..", title="Type in a name",
                         style="width:100px; margin-left: 0px; margin-right: 0px; padding: 0px;"):
                    pass
                with tag('input', type="text", id="myInput2", onkeyup="myFunction(2, 'myInput2')",
                         placeholder="Search for Status..", title="Type in a name",
                         style="width:100px; margin-left: 0px; margin-right: 0px; padding: 0px;"):
                    pass
                with tag('input', type="text", id="myInput3", onkeyup="myFunction(3, 'myInput3')",
                         placeholder="Search for Type..", title="Type in a name",
                         style="width:100px; margin-left: 0px; margin-right: 0px; padding: 0px;"):
                    pass
                with tag('input', type="text", id="myInput4", onkeyup="myFunction(4, 'myInput4')",
                         placeholder="Search for Business..", title="Type in a name",
                         style="width:100px; margin-left: 0px; margin-right: 0px; padding: 0px;"):
                    pass
